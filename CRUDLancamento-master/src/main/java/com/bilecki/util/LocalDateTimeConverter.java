...
public class LocalDateTimeConverter extends DateTimeConverter {
	public static final String ID="com.bilecki.util.LocalDateTimeConverter"; 
	...
	public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value) { 
		...
		if(object instanceof Date){ 
			...
			throw new IllegalArgumentException(String.format("value=%s Não foi possível "
					+ "converter LocalDateTime, resultado super.getAsObject=%s",value,object));			
		}
	}
	...
	public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value) { 
		...
		if(value instanceof LocalDateTime){ 
			...
			throw new IllegalArgumentException(String.format("value=%s não é um "
					+ "LocalDateTime",value));  
		} 
	}
}
